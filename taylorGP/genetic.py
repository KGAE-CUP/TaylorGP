    ...
    def _verbose_reporter(self, run_details=None):
        ...
        if run_details is None:
            ...
            print(line_format.format(run_details['generation'][-1],
                                     ...
                                     oob_fitness,
                                     remaining_time))
    def fit(self, X, y,qualified_list,eq_write,sample_weight=None):
        ...
        for gen in range(prior_generations, self.generations):
            ...
            if gen == 0:
                ...
                eq_write.write(str(gen-1) + '|')
                for i in range(10):
                    eq_write.write(str(parents[i])+'|' + str(parents[i].length_)+'|' + str(parents[i].raw_fitness_)+'|')
                eq_write.write('\n')
